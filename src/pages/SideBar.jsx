        ...
        <div className={`h-screen relative p-2 flex flex-col justify-between bg-white`}>
            <div>
                ...
                <nav className="flex flex-col gap-4 p_font">
                    ...
                    ${isActive ? "bg-black shadow-md text-white" : "hover:bg-gray-800 text-black hover:text-white"
                                    }`}
                            >
                                {route.icon}
                                <span className="text-[16px] font-normal">{route.component}</span>
                            </Link>
                        );
                    })}
                </nav>
            ...
            <div className="w-full flex justify-center">
                <Tooltip title={"Logout"}>
                    <button onClick={handlerLogout} className="flex items-center justify-center gap-4 bg-red-500 px-4 py-2 rounded-full transition-all duration-300 hover:bg-red-600 text-white font-medium">
                        Logout
